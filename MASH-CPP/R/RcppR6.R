...
## Version: 0.2.4
## Hash: fa2eac7f742fbd22d6d429d3ae418c01
...
##'   * a field:
##' @export
`ELP` <- function(alpha_new=0.1, gamma_new=0.1, psi_new=0.01, sigma_new=1) {
  ELP__ctor(alpha_new, gamma_new, psi_new, sigma_new)
}
.R6_ELP <-
  R6::R6Class(
    "ELP",
    ...
    public=list(
      ...
      oneDay_aquaticDynamics = function() {
        ELP__oneDay_aquaticDynamics(self)
      },
      ...
      set_sigma = function(sigma_new) {
        ELP__set_sigma(self, sigma_new)
      },
      get_L = function() {
        ELP__get_L(self)
      },
      set_L = function(L_new) {
        ELP__set_L(self, L_new)
      },
      get_E = function() {
        ELP__get_E(self)
      },
      set_E = function(E_new) {
        ELP__set_E(self, E_new)
      },
      get_P = function() {
        ELP__get_P(self)
      },
      set_P = function(P_new) {
        ELP__set_P(self, P_new)
      },
      get_ELP = function() {
        ELP__get_ELP(self)
      },
      set_ELP = function(E_new, L_new, P_new) {
        ELP__set_ELP(self, E_new, L_new, P_new)
      },
      get_parameters = function() {
        ELP__get_parameters(self)
      },
      set_parameters = function(alpha_new, gamma_new, psi_new, sigma_new) {
        ELP__set_parameters(self, alpha_new, gamma_new, psi_new, sigma_new)
      },
      reset = function() {
        ELP__reset(self)
      }),
