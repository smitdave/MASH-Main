...
## Version: 0.2.4
## Hash: 3340907945891ab0cf2e7a8957cd79c6
...
##'   * a field:
##' @export
`ELPool` <- function(alpha_new=0.1, gamma_new=0.1, psi_new=0.01, sigma_new=1) {
  ELPool__ctor(alpha_new, gamma_new, psi_new, sigma_new)
}
.R6_ELPool <-
  R6::R6Class(
    "ELPool",
    ...
    public=list(
      ...
      oneStep = function() {
        ELPool__oneStep(self)
      },
      get_psi = function() {
        ELPool__get_psi(self)
      },
      set_psi = function(psi_new) {
        ELPool__set_psi(self, psi_new)
      },
      get_alpha = function() {
        ELPool__get_alpha(self)
      },
      set_alpha = function(alpha_new) {
        ELPool__set_alpha(self, alpha_new)
      },
      get_gamma = function() {
        ELPool__get_gamma(self)
      },
      set_gamma = function(gamma_new) {
        ELPool__set_gamma(self, gamma_new)
      },
      get_sigma = function() {
        ELPool__get_sigma(self)
      },
      set_sigma = function(sigma_new) {
        ELPool__set_sigma(self, sigma_new)
      },
      get_L = function() {
        ELPool__get_L(self)
      },
      set_L = function(L_new) {
        ELPool__set_L(self, L_new)
      },
      get_E = function() {
        ELPool__get_E(self)
      },
      set_E = function(E_new) {
        ELPool__set_E(self, E_new)
      },
      get_ELPool = function() {
        ELPool__get_ELPool(self)
      },
      set_ELPool = function(E_new, L_new) {
        ELPool__set_ELPool(self, E_new, L_new)
      },
      get_parameters = function() {
        ELPool__get_parameters(self)
      },
      set_parameters = function(alpha_new, gamma_new, psi_new, sigma_new) {
        ELPool__set_parameters(self, alpha_new, gamma_new, psi_new, sigma_new)
      },
      reset = function() {
        ELPool__reset(self)
      }),
