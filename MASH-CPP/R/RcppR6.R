...
## Version: 0.2.4
## Hash: 1df150497db44dce38e85dfc769f293f
...
.R6_humanPfSI <-
  R6::R6Class(
    ...
    public=list(
      ...
      track_history = function(tEvent, event, vectorInf_new) {
        humanPfSI__track_history(self, tEvent, event, vectorInf_new)
      },
      get_history = function() {
...
##' @md
##' @export
`mosquitoPfSI` <- function(PfID_init, tInf_init=-1, infected_init=FALSE) {
  mosquitoPfSI__ctor(PfID_init, tInf_init, infected_init)
}
.R6_mosquitoPfSI <-
  R6::R6Class(
    "mosquitoPfSI",
