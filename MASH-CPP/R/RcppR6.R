...
## Version: 0.2.4
## Hash: ca99ffe401cbb8b4ecf930c208f5aaf8
...
##' @md
##' @export
`humanPfMOI` <- function(PfID_init, tInf_init=-1, MOI_init=0, b_init=0.55, c_init=0.15, chemoprophylaxis_init=FALSE, N=20) {
  humanPfMOI__ctor(PfID_init, tInf_init, MOI_init, b_init, c_init, chemoprophylaxis_init, N)
}
.R6_humanPfMOI <-
  R6::R6Class(
    "humanPfMOI",
    ...
    public=list(
      ...
      get_vectorInf = function() {
        humanPfMOI__get_vectorInf(self)
      },
      push_vectorInf = function(vectorInf_new) {
        humanPfMOI__push_vectorInf(self, vectorInf_new)
      },
      get_chemoprophylaxis = function() {
      ...
      add_Infection = function(PfID_new) {
        humanPfMOI__add_Infection(self, PfID_new)
      },
...
##' @md
##' @export
`mosquitoPfMOI` <- function(PfID_init, MosquitoID_init, tInf_init=-1, MOI_init=0) {
  mosquitoPfMOI__ctor(PfID_init, MosquitoID_init, tInf_init, MOI_init)
}
.R6_mosquitoPfMOI <-
  R6::R6Class(
    "mosquitoPfMOI",
    ...
    public=list(
      ...
      get_MosquitoID = function() {
        mosquitoPfMOI__get_MosquitoID(self)
      },
      set_MosquitoID = function(MosquitoID_new) {
        mosquitoPfMOI__set_MosquitoID(self, MosquitoID_new)
      },
      get_tInf = function() {
      ...
      get_humanInf = function() {
        mosquitoPfMOI__get_humanInf(self)
      },
      push_humanInf = function(humanInf_new) {
        mosquitoPfMOI__push_humanInf(self, humanInf_new)
      },
      get_history = function() {
        mosquitoPfMOI__get_history(self)
      },
      add_Infection = function(PfID_new, tInf_new, humanInf_new) {
        mosquitoPfMOI__add_Infection(self, PfID_new, tInf_new, humanInf_new)
      },
...
.R6_MatingQ <-
  R6::R6Class(
    ...
    public=list(
      ...
      add_male2Q = function(maleID_new, mateFitness_new) {
        MatingQ__add_male2Q(self, maleID_new, mateFitness_new)
      },
