...
#' @param F_surv blood feeding search bout baseline survival probaility (see \code{\link{mbites_surviveFlight}})
#' @param B_surv blood feeding attempt bout baseline survival probaility (see \code{\link{mbites_surviveFlight}})
#' @param R_surv post-prandial resting bout baseline survival probaility (see \code{\link{mbites_surviveFlight}})
#' @param L_surv egg laying search bout baseline survival probaility (see \code{\link{mbites_surviveFlight}})
#' @param O_surv egg laying attempt bout baseline survival probaility (see \code{\link{mbites_surviveFlight}})
#' @param M_surv mating bout baseline survival probaility (see \code{\link{mbites_surviveFlight}})
#' @param S_surv sugar feeding attempt bout baseline survival probaility (see \code{\link{mbites_surviveFlight}})
...
#' @param bm.a shape param for bloodmeal size (see \code{\link{mbites_rBloodMealSize}})
#' @param bm.b shape param for bloodmeal size (see \code{\link{mbites_rBloodMealSize}})
#' @param REFEED control boolean for refeeding behavior during resting bout
#' @param rf.a exp param for refeeding as function of bmSize (see \code{\link{mbites_pReFeed}})
#' @param rf.b exp param for refeeding as function of bmSize (see \code{\link{mbites_pReFeed}})
#' @param OVERFEED control boolean for overfeeding during \code{\link{mbites_BloodMeal}}
#' @param of.a exp param for overfeeding as function of bmSize (see \code{\link{mbites_pOverFeed}})
#' @param of.b exp param for overfeeding as function of bmSize (see \code{\link{mbites_pOverFeed}})
#' @param SENESCE control boolean for senesce mortality during \code{\link{mbites_surviveFlight}}
#' @param sns.a exp param for senescence (see \code{\link{mbites_pSenesce}})
#' @param sns.b exp param for senescence (see \code{\link{mbites_pSenesce}})
#' @param TATTER control boolean for wing tattering during \code{\link{mbites_surviveFlight}}
#' @param ttsz.p zero-inflation for tattering damage (see \code{\link{mbites_WingTattering}})
#' @param ttsz.a shape param for tattering damage (see \code{\link{mbites_WingTattering}})
#' @param ttsz.b shape param for tattering damage (see \code{\link{mbites_WingTattering}})
#' @param ttr.a exp param for tattering survival (see \code{\link{mbites_pTatter}})
#' @param ttr.b exp param for tattering survival (see \code{\link{mbites_pTatter}})
...
#' @param bs.m mean of normally-distributed egg batch size (used in \code{\link{mbites_rBatchSizeNorm}})
#' @param bs.v standard deviation of normally-distributed egg batch size (used in \code{\link{mbites_rBatchSizeNorm}})
#' @param maxBatch maximum egg batch size (used in \code{\link{mbites_rBatchSizeBms}})
#' @param emt.m mean of normally-distributed egg batch maturation time (used in \code{\link{mbites_rEggMaturationTimeNorm}})
#' @param emt.v standard deviation of normally-distributed egg batch maturation time (used in \code{\link{mbites_rEggMaturationTimeNorm}})
...
MBITES.Complex.Parameters <- function(
  ...
  bs.m                    = 30, # used in mbites_rBatchSizeNorm
  bs.v                    = 5, # used in mbites_rBatchSizeNorm
  maxBatch                = 30, # maximum egg batch size (used in mbites_rBatchSizeBms)
  emt.m                   = 3, # used in mbites_rEggMaturationTimeNorm
  emt.v                   = 1, # used in mbites_rEggMaturationTimeNorm
