...
compiled_conversion_curves_ensemble <- data.table(time = NA, location = NA, status = NA, N = NA)
compiled_full_curves_ensemble <- data.table(time = NA, location = NA, status = NA, N = NA)
