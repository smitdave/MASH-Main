...
filename = "/Users/dtcitron/Documents/MASH/MASH-Main/MASH-dev/DanielCitron/MBITES_vector_bionomics/mosquito_F_1.json"
...
bionomics.data <- combine.bionomics.data(filename, EIP=2)
