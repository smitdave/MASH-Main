...
for( i in 1:26){
  flnm = paste("peridom.f", 100+i, ".xyw", sep="")
  write.table(data.frame(pointsets[[i]]$xy.f), flnm, sep = ",")
  flnm = paste("peridom.l", 100+i, ".xyw", sep="")
  write.table(data.frame(pointsets[[i]]$xy.l), flnm, sep = ",")
}
