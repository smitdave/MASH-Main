...
Default egg maturation option. 

Default refeeding option. 
...
\item \verb1flightEnergetics=TRUE1
  ...
  \item \verb8flightEnergetics_bloodTopUp_EU=08 :: Settting this to zero means a mosquito tops up to full after every blood meal. Setting it to some other number $x$ (in energy units) bigger than zero means it is able to take $x$ flights as a result of blood feeding. 
...
\item \verb1sugarFeeding = TRUE1
  ...
  \item \verb1sugarFeeding_boutS=TRUE1 (see below)
  \item \verb1sugarFeeding_opportunistic=FALSE1
  \item \verb1sugarFeeding_opportunistic=TRUE1 (see below)
  \item \verb8flightEnergetics_sugarTopUp_EU=08 :: Settting this to zero means a mosquito tops up to full after every sugar meal. Setting it to some other number $x$ (in energy units) bigger than zero means it is able to take $x$ flights as a result of sugar feeding. 
  \end{itemize}
\end{itemize}
...
\section{Blood Meal and Egg Batch Dynamics}

\subsection{Size of Blood Meal and Egg Batch}
