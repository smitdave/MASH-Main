...
Every mosquito event can be logged so it is possible to study mosquitoes using  \verb1historyTrack1, which outputps a mosquito's state at the end of each bout. 
