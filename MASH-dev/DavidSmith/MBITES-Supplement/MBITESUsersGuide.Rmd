...
* A generalized exponential family of functions that includes a fixed delay. The parameter $tte_x$ is the expected waiting time to the event, and $dlay_x < tte_x$ is the fixed delay. The waiting time is the random variate $$dlay_x + rexp \left(\frac{1}{rate = tte_x - dlay_x}\right) $$. 
...
pReFeed <- function(x,rf_a=10,rf_b=4){
