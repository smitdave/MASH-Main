...
#'
#'
mbites2mbdetes_getSurvLaden =function(){
  lrl = getRestingParam()
...
#'
#'
mbites2mbdetes_getLeaveLaden=function(){
  lrl = mbites2mbdetes_getRestingParam()
  land = lrl[1]; retry = lrl[2]; leave = lrl[3]
  PPR_a = MBITES:::Parameters$get_PPR_a()
  PPR_b = MBITES:::Parameters$get_PPR_b()
  bm_a = MBITES:::Parameters$get_bm_a()
...
#'
#'
mbites2mbdetes_getSurvUnaden =function(){
  lrl = mbites2mbdetes_getRestingParam()
  land = lrl[1]; retry = lrl[2]; leave = lrl[3]
  (land+leave)/(1-retry)
}
...
#'
#'
mbites2mbdetes_getLeaveUnaden =function(){
  lrl = mbites2mbdetes_getRestingParam()
  land = lrl[1]; retry = lrl[2]; leave = lrl[3]
  leave/(1-retry)
}
...
#'
mbites2mbdetes_getRestingParam = function(){
  if(private$site$get_type()==1L){
    # use "l" because that is the rspot when a mosquito arrives at a new site
     probs = MBITES:::Parameters$get_InAndOut_row("l") * MBITES:::Parameters$get_wts(private$state)
     land = sum(probs[1:3])
     retry = probs[4]
     leave = probs[5]
  # not homestead
...
#'
#'
mbites2mbdetes_FstateTransitions = function(i){
  # F -> F, B, D
...
#'  R-> B, F, L, O, D
#'
mbites2mbdetes_RperiodTransitions = function(){
  ##########################################################
...
#'
#'
mbites2mbdetes_LstateTransitions = function(i){
...
#'
#'
mbites2mbdetes_OstateTransitions = function(){
...
#'
mbites2mbdetes_StateTransitions = function(i){
