...
MosquitoFemale <- R6::R6Class(classname = "MosquitoFemale",
                          ...
                          public = list(
                            ...
                            initialize = function(id, time, locNow, genotype, state, pSetNow = "l", eggT = 0, eggP = 0, energyPreG = 0){
                              ...
                              # Behavioral State 
                              private$state        = state       # {B,R,O,S,M,E,D}
                              ...
                              # Energetics  
                              private$starved   = FALSE    # energy reserves
                              private$energy    = 1        # energy reserves

                              # Egg Batch Variables
                              private$bloodfed = FALSE   # bloodfed (triggers post-prandial resting period)  
                              private$gravid = FALSE     # gravid (triggers egg laying) 
                              ...
                              private$mated        = FALSE       # mated 
                              private$energyPreG  = energyPreG   # MBITES_PAR pre-gonotrophic energy requirement

                              # Other State Variables
                              private$damage_physical = 0   # e.g. wing tattering
                              private$damage_chemical = 0   # e.g. insecticides 
