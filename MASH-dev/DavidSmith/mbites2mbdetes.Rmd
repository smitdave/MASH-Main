...
$$\hat P_{R,R} = P_{R,B} \hat P_{B,R} T_{R,B} + P_{R,O} \hat P_{O,B} \hat P_{B,R} \left(T_{O,B} + T_{R,B}\right)$$

$$\hat P_{R,R} = 
\frac{P_{R,B}  \left( \frac{P_{R,B}}{1-P_{B,B}} \frac{t_B}{1-P_{B,B}} \right)+ P_{R,O}\frac{P_{O,B}}{1-P_{O,O}} \frac{P_{B,R}}{1-P_{B,B}} \left( \frac{t_O}{1-P_{O,O}} +  \frac{t_B}{1-P_{B,B}}\right)}{P_{R,B}+P_{R,O}}.$$  
...
and: 
$$ T_{B,R} = P_{B,R} t_B + P_{B,B} T_{B,R} + P_{B,F} \hat P_{B,F} \left(T_{B,F} +  T_{B,R} \right) \\ = \frac{P_{B,R}  t_B + P_{B,F} \hat P_{B,F} \left(T_{B,F} +  T_{B,R} \right)}{1-P_{B,B} - P_{B,F} \hat P_{B,F}} 
$$
