...
The following formulas make the translation from these formulas to the basic bionomic parameters. Let $1/f$ denote the average duration of a feeding cycle:
$$1/f= T_{R,R} = \sum_{X \in \left\{F,B,L,O\right\}} P_{R,X} \hat P_{X,R} T_{X,R} $$
Survival through a full feeding cycle is: 
$$e^{-g/f} = \hat P_{R,R} = \sum_{X \in \left\{F,B,L,O\right\}} P_{R,X} \hat P_{X,R}$$
