...
Fever[1:dur[1],1] = fever[1:pospos[1]]
for(i in 2:334){
...
plot(cumsum(TEmu)*exp(-lambda),type="l",xlim=c(0,200))

plot(log10(GTmu[10:300]),TEmu[10:300],type="l")
plot(log10(GTmu[20:300]),TEmu[20:300],type="l")
plot(log10(GTmu[20:300]),TEmu[20:300])

ccf(GTmu[10:300],TEmu[10:300])
ccf(GTmu[20:300],TEmu[20:300])
cor(GTmu[20:300],TEmu[20:300])
