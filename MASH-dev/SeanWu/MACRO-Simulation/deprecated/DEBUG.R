...
# read in data
tororo <- read.table("/Users/slwu89/Desktop/git/MASH-Main/MASH-dev/SeanWu/MACRO-Simulation/data/TOROROnew.txt", header=T)
jinja <- read.table ("/Users/slwu89/Desktop/git/MASH-Main/MASH-dev/SeanWu/MACRO-Simulation/data/JINJAnew.txt", header=T)
kanungu <- read.table("/Users/slwu89/Desktop/git/MASH-Main/MASH-dev/SeanWu/MACRO-Simulation/data/KANUNGUnew.txt", header=T)
...
fitit.fQ(30, kanungu, 0,0)
# text(50, 3, "Kanungu")
T.f <- fitit.fQ(61, tororo,0,0)
fitit.fQ(41, tororo,0,0)
# text(1, 3, "Tororo")
# par(mfrow=c(1,1))
