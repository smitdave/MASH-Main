...
saveRDS(object = simout,file = here::here("sim/PfMOI_hom.rds"))
...
#
# ggsave(filename = here::here("figures/pfmoi_4_hom.pdf"),plot = fig4,device = "pdf",width = 12,height = 10)
